INTERFACE
SUBROUTINE FPEZO2H(YDQTYPE,KFLD,KCOD,LDBIP,YDCLIMO,PWSXI,PWDXI,YDNAMFPSCI,YDAFN,KFPXFLD,YDFPGEO,YDEPHY,YDML_PHY_MF,&
 & YDFPUSERGEO,CDCONF,LDFPOSHOR,LDMPHYS,PDATA,YDAUX) 
