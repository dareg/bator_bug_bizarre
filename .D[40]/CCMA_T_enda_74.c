...
PUBLIC int
CCMA_Sel_T_enda_74(void *T, ODB_PE_Info *PEinfo, int phase, void *feedback)
{
  TABLE_enda_74 *P = T;
  ODBMAC_TABLE_DELAYED_LOAD(enda_74);
  return P->Nrows;
}


PreGetTable(CCMA, d, double, enda_74)
  Call_CopyGet_TABLE(CCMA, d, 1, enda_74, pk1int, D, member, Count, DATATYPE_INT4);
  Call_CopyGet_TABLE(CCMA, d, 2, enda_74, Bitfield, D, report_status, Count, DATATYPE_BITFIELD);
  Call_CopyGet_TABLE(CCMA, d, 3, enda_74, Bitfield, D, report_event1, Count, DATATYPE_BITFIELD);
  Call_CopyGet_TABLE(CCMA, d, 4, enda_74, pk9real, D, obsvalue, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 5, enda_74, Bitfield, D, datum_anflag, Count, DATATYPE_BITFIELD);
  Call_CopyGet_TABLE(CCMA, d, 6, enda_74, Bitfield, D, datum_status, Count, DATATYPE_BITFIELD);
  Call_CopyGet_TABLE(CCMA, d, 7, enda_74, Bitfield, D, datum_event1, Count, DATATYPE_BITFIELD);
  Call_CopyGet_TABLE(CCMA, d, 8, enda_74, pk9real, D, biascorr, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 9, enda_74, pk9real, D, biascorr_fg, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 10, enda_74, pk9real, D, an_depar, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 11, enda_74, pk9real, D, fg_depar, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 12, enda_74, pk9real, D, qc_pge, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 13, enda_74, pk9real, D, final_obs_error, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 14, enda_74, pk9real, D, obs_error, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 15, enda_74, pk9real, D, fg_error, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 16, enda_74, pk9real, D, skintemp_1, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 17, enda_74, pk9real, D, skintemp_2, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 18, enda_74, pk9real, D, skintemp_3, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 19, enda_74, pk9real, D, skintemp_4, Count, DATATYPE_REAL8);
  Call_CopyGet_TABLE(CCMA, d, 20, enda_74, pk9real, D, skintemp_5, Count, DATATYPE_REAL8);
PostGetTable(d, double, enda_74)


PrePutTable(CCMA, d, double, enda_74)
  Call_CopyPut_TABLE(CCMA, d, 1, enda_74, pk1int, member, D, Count, DATATYPE_INT4);
  Call_CopyPut_TABLE(CCMA, d, 2, enda_74, Bitfield, report_status, D, Count, DATATYPE_BITFIELD);
  Call_CopyPut_TABLE(CCMA, d, 3, enda_74, Bitfield, report_event1, D, Count, DATATYPE_BITFIELD);
  Call_CopyPut_TABLE(CCMA, d, 4, enda_74, pk9real, obsvalue, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 5, enda_74, Bitfield, datum_anflag, D, Count, DATATYPE_BITFIELD);
  Call_CopyPut_TABLE(CCMA, d, 6, enda_74, Bitfield, datum_status, D, Count, DATATYPE_BITFIELD);
  Call_CopyPut_TABLE(CCMA, d, 7, enda_74, Bitfield, datum_event1, D, Count, DATATYPE_BITFIELD);
  Call_CopyPut_TABLE(CCMA, d, 8, enda_74, pk9real, biascorr, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 9, enda_74, pk9real, biascorr_fg, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 10, enda_74, pk9real, an_depar, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 11, enda_74, pk9real, fg_depar, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 12, enda_74, pk9real, qc_pge, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 13, enda_74, pk9real, final_obs_error, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 14, enda_74, pk9real, obs_error, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 15, enda_74, pk9real, fg_error, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 16, enda_74, pk9real, skintemp_1, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 17, enda_74, pk9real, skintemp_2, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 18, enda_74, pk9real, skintemp_3, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 19, enda_74, pk9real, skintemp_4, D, Count, DATATYPE_REAL8);
  Call_CopyPut_TABLE(CCMA, d, 20, enda_74, pk9real, skintemp_5, D, Count, DATATYPE_REAL8);
PostPutTable(d, double, enda_74)
...
PostStoreTable(enda_74)

DefineLookupTable(enda_74)

PUBLIC void
CCMA_Dim_T_enda_74(void *T, int *Nrows, int *Ncols,
  int *Nrowoffset, int ProcID)
{
  TABLE_enda_74 *P = T;
  Call_LookupTable(enda_74, P, Nrows, Ncols);
  if (Nrowoffset) *Nrowoffset = 0;
}

PUBLIC void
CCMA_Swapout_T_enda_74(void *T)
{
  TABLE_enda_74 *P = T;
  int Nbytes = 0;
  int Count = 0;
  ...
  ODBMAC_TRACE_SWAPOUT(enda_74,20);
}

DefineRemoveTable(CCMA, enda_74)

PUBLIC int
CCMA_Sql_T_enda_74(FILE *fp, int mode, const char *prefix, const char *postfix, char **sqlout) { ODBMAC_TABLESQL(); }

PUBLIC void *
CCMA_Init_T_enda_74(void *T, ODB_Pool *Pool, int Is_new, int IO_method, int it, int dummy)
{
  TABLE_enda_74 *P = T;
  int PoolNo = Pool->poolno;
  ODB_Funcs *pf;
  static ODB_CommonFuncs *pfcom = NULL; /* Shared between pools & threads */
  DRHOOK_START(CCMA_Init_T_enda_74);
  if (!P) ALLOC(P, 1);
  PreInitTable(P, 20);
  InitDS(pk1int, DATATYPE_INT4, member, enda_74, 1);
  InitDS(Bitfield, DATATYPE_BITFIELD, report_status, enda_74, 1);
  InitDS(Bitfield, DATATYPE_BITFIELD, report_event1, enda_74, 1);
  InitDS(pk9real, DATATYPE_REAL8, obsvalue, enda_74, 9);
  InitDS(Bitfield, DATATYPE_BITFIELD, datum_anflag, enda_74, 1);
  InitDS(Bitfield, DATATYPE_BITFIELD, datum_status, enda_74, 1);
  InitDS(Bitfield, DATATYPE_BITFIELD, datum_event1, enda_74, 1);
  InitDS(pk9real, DATATYPE_REAL8, biascorr, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, biascorr_fg, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, an_depar, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, fg_depar, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, qc_pge, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, final_obs_error, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, obs_error, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, fg_error, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, skintemp_1, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, skintemp_2, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, skintemp_3, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, skintemp_4, enda_74, 9);
  InitDS(pk9real, DATATYPE_REAL8, skintemp_5, enda_74, 9);
  if (!pfcom) { /* Initialize once only */
    CALLOC(pfcom,1);
    { static char s[] = "@enda_74"; pfcom->name = s; }
    pfcom->is_table = 1;
    ...
    pfcom->rank = 223;
    pfcom->wt = 358.000199;
    pfcom->tags = CCMA_Set_T_enda_74_TAG(&pfcom->ntag, &pfcom->nmem);
    pfcom->preptags = CCMA_Set_T_enda_74_PREPTAG(&pfcom->npreptag);
    pfcom->Info = NULL;
    pfcom->create_index = 0;
    pfcom->init = CCMA_Init_T_enda_74;
    pfcom->swapout = CCMA_Swapout_T_enda_74;
    pfcom->dim = CCMA_Dim_T_enda_74;
    pfcom->sortkeys = NULL;
    pfcom->update_info = NULL;
    pfcom->aggr_info = NULL;
    pfcom->getindex = NULL; /* N/A */
    pfcom->putindex = NULL; /* N/A */
    pfcom->select = CCMA_Sel_T_enda_74;
    pfcom->remove = CCMA_Remove_T_enda_74;
    pfcom->peinfo = NULL; /* N/A */
    pfcom->cancel = NULL;
    pfcom->dget = CCMA_dGet_T_enda_74; /* REAL(8) dbmgr */
    pfcom->dput = CCMA_dPut_T_enda_74; /* REAL(8) dbmgr */
    pfcom->load = CCMA_Load_T_enda_74;
    pfcom->store = CCMA_Store_T_enda_74;
    pfcom->pack = CCMA_Pack_T_enda_74;
    pfcom->unpack = CCMA_Unpack_T_enda_74;
    pfcom->sql = CCMA_Sql_T_enda_74;
    pfcom->ncols_aux = 0;
    pfcom->colaux = NULL;
