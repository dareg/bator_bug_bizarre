...
REAL(KIND=JPRD), INTENT(OUT)    :: TO(NCOLS, NCHUNK)
REAL(KIND=JPRD), INTENT(IN)     :: FROM(NRA,0:NCOLS)
INTEGER(KIND=JPIM), INTENT(OUT) :: RC
INTEGER :: JROW, JCOL
LOGICAL :: LLSWAPBYTES 
REAL(KIND=JPRD) :: ZHOOK_HANDLE
...
REAL(KIND=JPRD), INTENT(OUT)      :: A(NRA,0:NCOLS)
INTEGER(KIND=JPIM), INTENT(OUT)   :: RC
REAL(KIND=JPRD) :: ZHOOK_HANDLE
...
REAL(KIND=JPRD), INTENT(IN)     :: NEWVALUE
REAL(KIND=JPRD), INTENT(OUT)    :: OLDVALUE
REAL(KIND=JPRD) :: ZHOOK_HANDLE
