...
SUBROUTINE SURFTSTP    (YDSURF, KIDIA , KFDIA , KLON  , KLEVS , KTILES,&
 ...
 & PUSTOKES,PVSTOKES,PPHIOC  ,PPHIAW  ,&
 & PTAUOC  ,PEMEAN  ,PFMEAN  ,&
!-DIAGNOSTICS OUTPUT
 & PTSDFL  , PROFD , PROFS,&
...
!    *PPHIOC*     NORMALIZED ENERGY FLUX INTO OCEAN                   
!    *PPHIAW*     NORMALIZED ENERGY FLUX FROM AIR TO OCEAN WAVES              
!    *PTAUOC*     NORMALIZED STRESS APPLIED BY OCEAN WAVES TO OCEAN
!    *PEMEAN*     WAVE VARIANCE
!    *PFMEAN*     MEAN FREQUENCY
...
REAL(KIND=JPRB)   ,INTENT(IN)    :: PPHIAW(:) 
REAL(KIND=JPRB)   ,INTENT(IN)    :: PTAUOC(:)
REAL(KIND=JPRB)   ,INTENT(IN)    :: PEMEAN(:)
REAL(KIND=JPRB)   ,INTENT(IN)    :: PFMEAN(:)
