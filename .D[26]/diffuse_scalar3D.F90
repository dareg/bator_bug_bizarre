subroutine diffuse_scalar3D (field,field0,fluxb,fluxt,tkh,rho,rhow,flux)
...
real(RR) flux(nz)
! local        
real(RR) flx(0:nx,0:ny,0:nzm)
real(RR) dfdt(nx,ny,nz)
real(RR) rdx2,rdy2,rdz2,rdz,rdx5,rdy5,rdz5,tmp
real(RR) dxy,dxz,dyx,dyz,dzx,dzy,tkx,tky,tkz,rhoi
