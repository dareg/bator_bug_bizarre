...
integer i,j,k, kb, kc
real(RR) dtabs, tabs1, an, bn, ap, bp, om, ag, omp
real(RR) fac1,fac2  
real(RR) fff,dfff,qsatt,dqsat
real(RR) lstarn,dlstarn,lstarp,dlstarp
integer niter
...
! call t_startf ('cloud') ! commented by Phani
...
! call t_stopf ('cloud') ! commented by Phani
