...
real(RR) f(dimx1:dimx2, dimy1:dimy2, dimz),fm(nzm), factor
integer i,j,k
factor = 1./(nx*ny)
do k =1,nzm
 fm(k) = 0.
...
implicit none
integer dimx1, dimx2, dimy1, dimy2, dimz
real(RR) f(dimx1:dimx2, dimy1:dimy2, dimz),fm(nzm),fm1(nzm),factor
integer i,j,k
factor = 1./(nx*ny)
do k =1,nzm
 fm(k) = 0.
...
implicit none
integer dimx1, dimx2, dimy1, dimy2, dimz
real(RR) f(dimx1:dimx2, dimy1:dimy2, dimz),fmn(nz),fmx(nz)
character *(*) name
real(RR) fmin(1),fmax(1),fff(1)
integer i,j,k
