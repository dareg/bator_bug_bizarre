...
real(RR) div, divmax, divmin
real(RR) rdx, rdy, rdz, coef
integer im,jm,km
real(RR) wmax, qnmax(1), qnmax1(1)
...
! call t_startf ('print_out') ! commented by Phani
...
!print*,'p:'
!write(6,'(16f7.2)')((p(i,1,k),i=1,16),k=30,1,-1)
print*,'u:'
write(6,'(16f7.2)')((u(i,1,k),i=1,16),k=30,1,-1)
!print*,'v:'
!write(6,'(16f7.2)')((v(i,1,k),i=1,16),k=30,1,-1)
print*,'w:'
write(6,'(16f7.2)')((w(i,1,k),i=1,16),k=30,1,-1)
print*,'qcl:'
write(6,'(16f7.2)')((qcl(i,1,k)*1000.,i=1,16),k=30,1,-1)
print*,'qci:'
write(6,'(16f7.2)')((qci(i,1,k)*1000.,i=1,16),k=30,1,-1)
print*,'qpl:'
write(6,'(16f7.2)')((qpl(i,1,k)*1000.,i=1,16),k=30,1,-1)
print*,'qpi:'
write(6,'(16f7.2)')((qpi(i,1,k)*1000.,i=1,16),k=30,1,-1)
!print*,'qrad:'
!write(6,'(16f7.2)')((qrad(i,1,k)*3600.,i=1,16),k=30,1,-1)
print*,'qv:'
write(6,'(16f7.2)')((qv(i,1,k)*1000.,i=1,16),k=30,1,-1)
print*,'tabs:'
write(6,'(16f7.2)')((tabs(i,1,k),i=1,16),k=30,1,-1)
!
!end if
...
! call t_stopf ('print_out') ! commented by Phani
