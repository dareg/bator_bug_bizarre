...
integer i,j,k
real(RR) autor, autos, accrr, accris, accrcs, accrig, accrcg
real(RR) dq, omn, omp, omg, qsatt
real(RR) pows1, pows2, powg1, powg2, powr1, powr2, tmp
real(RR) qii, qcc, qrr, qss, qgg
...
! call t_startf ('precip_proc') ! commented by Phani
     
associate(q=>micro_field(:,:,:,1),qp=>micro_field(:,:,:,2))
...
! call t_stopf ('precip_proc') ! commented by Phani
