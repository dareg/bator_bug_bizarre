...
real(RR) def2(nx,ny,nzm)
real(RR) grd,betdz,Ck,Ce,Ces,Ce1,Ce2,smix,Pr,Cee,Cs
real(RR) buoy_sgs,ratio,a_prod_sh,a_prod_bu,a_diss
real(RR) lstarn, lstarp, bbb, omn, omp
real(RR) qsatt,dqsat
integer i,j,k,kc,kb

! call t_startf('tke_full') ! commented by Phani
...
! call t_stopf('tke_full') ! commented by Phani
