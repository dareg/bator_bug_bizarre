...
!************** LICENSE END ******************
  ...
  110 continue
   ...
   50 continue
      ...
      use real_size
      real(RR) a(*),b(*),c(*),d(*),trigs(*)
      real(RR) c1,c2,c3,c4,s1,s2,s3,s4
      real(RR) sin36/0.587785252292473/,cos36/0.809016994374947/, &
