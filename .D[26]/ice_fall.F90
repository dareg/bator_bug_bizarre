...
real(RR) coef,dqi,lat_heat,vt_ice
real(RR) omnu, omnc, omnd, qiu, qic, qid, tmp_theta, tmp_phi
real(RR) fz(nx,ny,nz)
...
! call t_startf ('ice_fall') ! commented by Phani
...
! call t_stopf ('ice_fall') ! commented by Phani
