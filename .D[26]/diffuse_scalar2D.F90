subroutine diffuse_scalar2D (field,field0,fluxb,fluxt,tkh,rho,rhow,flux)
...
! input
real(RR) field(dimx1_s:dimx2_s, dimy1_s:dimy2_s, nzm)  ! scalar
real(RR) field0(nzm) ! horizonral mean
real(RR) tkh(0:nxp1, 1-YES3D:nyp1, nzm) ! eddy conductivity
...
! local        
real(RR) flx(0:nx,1,0:nzm)
real(RR) dfdt(nx,ny,nzm) 
real(RR) rdx2,rdz2,rdz,rdx5,rdz5,tmp
real(RR) dxz,dzx,tkx,tkz,rhoi
