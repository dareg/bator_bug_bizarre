...
real(RR) rdx2,rdy2,rdz2,rdz,rdx25,rdy25
real(RR) rdx21,rdy21,rdx251,rdy251,rdz25
real(RR) dxy,dxz,dyx,dyz,dzx,dzy

integer i,j,k,ic,ib,jb,jc,kc,kcu
real(RR) tkx, tky, tkz, rhoi, iadzw, iadz
real(RR) fu(0:nx,0:ny,nz),fv(0:nx,0:ny,nz),fw(0:nx,0:ny,nz)
