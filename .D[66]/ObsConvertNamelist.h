...
!   27/02/2014 : C. Payan     : ECTERR_ASCAT25_UVBYCELL, ECTERR_OSCAT50_UVBYCELL added
...
!-------------------------------------------------------------------
   ...
   NAMELIST / NADIRS / LLPRINT, ECTERO, ECTERR_SCAT_BYCELL,&
                     ...
                     & INbTypeBufr, INbTypeNetcdf, INbTypeHdf5,&
                     & MinSeviriSatid, MaxSeviriSatid ,MinMtvzaSatid, MaxMtvzaSatid,&
                     & MinScatterSatid, MaxScatterSatid, &
                     & MinAirsSatid, MaxAirsSatid, MinAmsubSatid, MaxAmsubSatid, &
                     & MinAmsuaSatid, MaxAmsuaSatid, MinAtmsSatid, MaxAtmsSatid,&
                     & MinHirsSatid, MaxHirsSatid, MinAmsrSatid, MaxAmsrSatid,&
                     & MinSaphirSatid, MaxSaphirSatid, MinMwhsxSatid, MaxMwhsxSatid,&
                     & MinMwts2Satid, MaxMwts2Satid,&
                     & MinMwriSatid, MaxMwriSatid, MinGeowindSatid, MaxGeowindSatid,&
                     & MinGeoradSatid, MaxGeoradSatid, MinCrisSatid, MaxCrisSatid,&
                     & MinIasiSatid, MaxIasiSatid, MinSsmisSatid, MaxSsmisSatid,&
                     & MinGmiSatid, MaxGmiSatid, MinGpsroSatid, MaxGpsroSatid,&
                     & MinAscatSatid, MaxAscatSatid,MinKuscatSatid,MaxKuscatSatid,&
                     & LPERTOBS, NMEMBER,ReadNamelObsThinning,&
                     & FORCE_MTD_POOL_BALANCE, PACKETSIZE_POOL_BALANCE,&
                     & LATMS_MANDATORY_AVG, LSSMIS_MANDATORY_AVG, LMWTS2_MANDATORY_AVG,&
                     & LAMSUB_MANDATORY_AVG, LSAPHIR_MANDATORY_AVG 

   NAMELIST / NETCDF / NSEVIRI, NSCATTER

   NAMELIST / HDF5 / HODIM, HMTVZA

   NAMELIST / BUFR / TS_AMSUA, TS_AMSUB, TS_HIRS, TS_GEOWIND, TS_GEORAD, TS_ATMS, TS_SSMIS,&
                   & TS_SSMI, TS_IASI, TS_CRIS, TS_AIRS, TS_GMI, TS_MWRI, TS_SAPHIR, TS_AMSR2,&
                   & TS_MWHSX,TS_GPSRO, TS_ASCAT, TS_KUSCAT, TS_MWTS2,&
                   & NbTempMaxLevels, TempSondOrTraj, TempSondSplit, ElimTemp0, ElimPilot0, NFREQVERT_TPHR,&
                   & SynopPsMethod, SynopPmslMaxHeight,&
                   & GpssolMethod, &
                   & llignore_tpd, ll_applyqc1, ll_applyqc2, ll_applyqc3, &
                   ...
                   & LPacome, LAeolus, LMdehs, CrisFsr, NbRainToKeep, RainSelectOrder, &
                   & ZSAMPL_RADAR
