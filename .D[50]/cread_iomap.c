...
//FLO: this has been repaired by ECMWF ? 
//THis problem is linked to the call abor1 NANDAT=0000 
//cause erroneous character passed to the fortran 
//leading to fwrite_iomap writing corrupted CCMA.iomap file at the end of screening + minims... 
