...
RTETA(PTIME)=PTIME/(YDCST%RDAY*365.25_JPRB)
REL(PTETA)=1.7535_JPRB+6.283076_JPRB*PTETA
REM(PTETA)=6.240075_JPRB+6.283020_JPRB*PTETA
RRS(PTETA)=YDCST%REA*(1.0001_JPRB-0.0163_JPRB*SIN(REL(PTETA))&
...
RDS(PTETA)=ASIN(SIN(YDCST%REPSM)*SIN(RLLLS(PTETA)))
