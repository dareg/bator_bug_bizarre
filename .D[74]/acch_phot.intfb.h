INTERFACE
SUBROUTINE ACCH_PHOT(KIDIA,KFDIA,KLON,KLEV,PMU0,PALB,PAPRSF,PTO3,PJRAT,LDAY)
USE PARKIND1, ONLY : JPIM, JPRB
USE ARPCLIM_CHEM_MODULE, ONLY : JPCHEM_NJ, CHEM_JDATA,&
...
LOGICAL, INTENT(OUT) :: LDAY(KLON)
END SUBROUTINE ACCH_PHOT
END INTERFACE
