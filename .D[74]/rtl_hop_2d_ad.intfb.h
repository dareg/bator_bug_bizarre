INTERFACE
SUBROUTINE RTL_HOP_2D_AD(YDGP5,ROBHDR,SATHDR,&
 & KMXRAD,KNRAD,KOBSTYPE,&
 & YDLIMBGRP,PICHAN,PITAN,PXPP,YDGP_AD) 
 ...
 REAL(KIND=JPRB), INTENT(INOUT) :: PXPP(YDGP5%NDLEN,KMXRAD)
 TYPE(TYPE_GOM_PLUS), INTENT(INOUT) :: YDGP_AD
END SUBROUTINE RTL_HOP_2D_AD
END INTERFACE
