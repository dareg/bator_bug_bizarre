INTERFACE
SUBROUTINE ACRADSAD(YDVAB, YDML_PHY_MF,KIDIA,KFDIA,KLON,KTDIA,KLEV,KJN,&
...
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFPLC(KLON,0:KLEV)
...
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFRSO(KLON,0:KLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFRTH(KLON,0:KLEV)
END SUBROUTINE ACRADSAD
END INTERFACE
