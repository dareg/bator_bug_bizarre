INTERFACE
SUBROUTINE PHYS_TL (YDERAD,YDML_PHY_SLIN,YDML_PHY_EC,YDRIP,KLEV, KLON, PVDIFTS,&
 & PT5 ,&
 & PQ5 ,&
 & PP5 ,&
 & PPH5 ,&
...
REAL (KIND=JPRB), INTENT (INOUT), DIMENSION (KLON,KLEV) :: PP, PT, PQ
