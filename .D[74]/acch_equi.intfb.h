INTERFACE
SUBROUTINE ACCH_EQUI(KIDIA,KFDIA,KLON,KNCHEM,PHNM,PK,LDAY,GHOXFAM,PART_HNO3,PART_H2O,PART_HCl,PART_HBr,PQM)
USE PARKIND1, ONLY : JPIM, JPRB
USE ARPCLIM_CHEM_MODULE, ONLY : JPCHEM_NK, CHEM_LSOLIDP, CHEM_LONLYSTRAT,&
