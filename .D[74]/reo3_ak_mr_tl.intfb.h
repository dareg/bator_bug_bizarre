INTERFACE
SUBROUTINE REO3_AK_MR_TL(KFLEVG,KPPM,KDLEN,KLEN,KDCOUNT,KCOUNT,JGEMS,&
 & ZVPOBS, ZVPOBS_L,&
 & KAK,PWAK,PRESO,PXP,PXPD,YDGP_TL,&
 & KDPP,PXO3,&
...
REAL(KIND=JPRB) ,INTENT(IN) :: ZVPOBS(KDLEN,KDCOUNT)
REAL(KIND=JPRB) ,INTENT(IN) :: ZVPOBS_L(KDLEN,KDCOUNT)
