INTERFACE
SUBROUTINE LAITVSPCQM(YDVSLETA,KPROMA,KPROMB,KSTART,KPROF,KFLEV,&
 & KFLDN,KFLDX,&
...
REAL(KIND=JPRB) ,INTENT(IN) :: PVINTWS(KPROMB,KFLEV,1:4)
REAL(KIND=JPRB) ,INTENT(IN) :: PXSPSL(KPROMA*(KFLDX-KFLDN+1))
