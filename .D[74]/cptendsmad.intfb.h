INTERFACE
SUBROUTINE CPTENDSMAD( YDPHY,YDSIMPHL,KPROMA, KSTART, KPROF, KFLEV,&
...
REAL(KIND=JPRB) ,INTENT(INOUT) :: PDIFCQ(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PDIFCS(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PDIFTQ(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PDIFTS(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFCCQL(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFCCQN(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFCSQL(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFCSQN(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFPLCL(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFPLCN(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFPLSL(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFPLSN(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFRSO(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFRTH(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PSTRCU(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PSTRCV(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PSTRDU(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PSTRDV(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PSTRTU(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PSTRTV(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PSTRMU(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PSTRMV(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFRMH(KPROMA,0:KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PRDELP(KPROMA,KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PAPHIF(KPROMA,KFLEV)
...
REAL(KIND=JPRB) ,INTENT(INOUT) :: PQL(KPROMA,KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PQI(KPROMA,KFLEV)
