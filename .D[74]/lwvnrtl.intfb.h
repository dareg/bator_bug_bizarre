...
REAL(KIND=JPRB) ,INTENT(OUT) :: PADJD5(KLON,KLEV+1)
REAL(KIND=JPRB) ,INTENT(OUT) :: PADJU5(KLON,KLEV+1)
REAL(KIND=JPRB) ,INTENT(OUT) :: PCNTRB5(KLON,KLEV+1,KLEV+1)
REAL(KIND=JPRB) ,INTENT(OUT) :: PDBDT5(KLON,NSIL,KLEV)
