INTERFACE
SUBROUTINE SUHIFCEAD(PLON0E,PDLONE,PLATE,KLATE,KLONE,&
...
REAL(KIND=JPRB) ,INTENT(INOUT) :: PFER(KNDIM1,KNFLDS)
REAL(KIND=JPRB) ,INTENT(IN) :: PFLDM(KNPTS,KNFLDS)
LOGICAL, OPTIONAL, INTENT(IN) :: LDNG
INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN) :: KMASK(KNPTS)
END SUBROUTINE SUHIFCEAD
END INTERFACE
