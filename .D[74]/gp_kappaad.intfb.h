...
REAL(KIND=JPRB) ,INTENT(INOUT) :: PUT0L(KPROMA,KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PVT0L(KPROMA,KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PVORT0(KPROMA,KFLEV)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PDIVT0(KPROMA,KFLEV)
