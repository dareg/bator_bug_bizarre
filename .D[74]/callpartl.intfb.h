INTERFACE
SUBROUTINE CALLPARTL(YDGEOMETRY,YDSURF,YDMODEL,KIDIA,KFDIA,KLON,KLEVS,KTILES,&
 & KSTGLO,&
 ...
 & PALCOEFF,&
 & PEMISF,&
 & PCVL , PCVH , PTVL , PTVH , PLAILC, PLAIHC,&
 & PSOTY , PCI , PSST,&
 & PGZ0MCL ,PLZ0HCL,&
 ...
 & PTENU5 , PTENV5,&
 & PNTOP , PNBAS , PACPR5, PACCPR5, PACCPR35,&
 & PUSTRTI5, PVSTRTI5, PAHFSTI5,PEVAPTI5 ,PTSKTI5,&
 & PT , PQ, PGFL, PGFL5_THE_REAL_ONE,&
 & PU , PV , PVERVEL,&
 & PL , PI , PA ,&
 & PRS1 , PRSF1,&
 & PAPRS , PAPRSF , PDELP,&
 ...
 & PTRAJ_PHYS, PGPHIST, PTRAJ_PHYS_TLAD,&
 & PHYS_MWAVE5,YDACV) 
USE TYPE_MODEL , ONLY : MODEL
USE GEOMETRY_MOD , ONLY : GEOMETRY
USE SURFACE_FIELDS_MIX , ONLY : TSURF
USE PARKIND1 , ONLY : JPIM, JPRB, JPRD
USE YOMTRAJ , ONLY : TRAJ_PHYS_TYPE, TRAJ_PHYS_TLAD_TYPE,LPRTTRAJ
...
REAL(KIND=JPRB) ,INTENT(INOUT) :: PGFL5(KLON,KLEV,YDMODEL%YRML_GCONF%YGFL%NDIM)
...
REAL(KIND=JPRB) ,INTENT(INOUT) :: PACCPR5(KLON)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PACCPR35(KLON)
...
REAL(KIND=JPRB) ,INTENT(INOUT) :: PGFL5_THE_REAL_ONE(KLON,KLEV,YDMODEL%YRML_GCONF%YGFL%NDIM5)
...
REAL(KIND=JPRB) ,INTENT(IN) :: PTIA(KLON,KLEVS)
...
REAL(KIND=JPRB) ,INTENT(INOUT),OPTIONAL :: PHYS_MWAVE5(KLON,KLEV,N_PHYS_MWAVE)
TYPE(ACV_CONTAINER),INTENT(INOUT),OPTIONAL :: YDACV
END SUBROUTINE CALLPARTL
END INTERFACE
