INTERFACE
SUBROUTINE ACOS_AK_OP(KFLEVG,KPPM,KDLEN,KLEN,KDCOUNT,KGRIBC,KCOUNT,&
 & KAK,PWAK,PAPAK,PAPTC,PRESO,PRESH5,PRESF5,PXP5,PXPD5,YDGP5,&
 & KDPP,PXGEMS) 
...
REAL(KIND=JPRB) ,INTENT(IN) :: PAPTC(KDLEN,KDCOUNT)
