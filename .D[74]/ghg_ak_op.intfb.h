INTERFACE
SUBROUTINE GHG_AK_OP(KFLEVG,KDLEN,KLEN,KDCOUNT,KGRIBC,KCOUNT,&
 & KAK,PWAK,PAPAK,PRESO,PRESH5,PRESF5,YDGP5,&
 & KDPP,PXGEMS,PDIFSP) 
...
REAL(KIND=JPRB) ,INTENT(INOUT), OPTIONAL :: PDIFSP(KDLEN,KDCOUNT)
END SUBROUTINE GHG_AK_OP
END INTERFACE
