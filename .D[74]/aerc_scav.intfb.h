INTERFACE
SUBROUTINE AERC_SCAV&
 & ( YDMODEL,KIDIA , KFDIA , KLON , KLEV , KAER , KAER_SCAV, KSTEP, PTSPHY,&
 & PRSF1, PDP , PTP, PFLXR, PFLXS, PCONDL, PCONDN, PCLCOV, PCLWAT, PCLICE, PRAIN, PSNOW, PCEN, PTENC0,&
...
REAL(KIND=JPRB),INTENT(IN) :: PCONDL(KLON,KLEV+1), PCONDN(KLON,KLEV+1)
