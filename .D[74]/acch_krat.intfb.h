INTERFACE
SUBROUTINE ACCH_KRAT(KIDIA,KFDIA,KLON,KLEV,PHNM,PT,PJRAT,PKRAT)
USE PARKIND1, ONLY : JPIM, JPRB
USE ARPCLIM_CHEM_MODULE, ONLY : CHEM_LONLYSTRAT, JPCHEM_NJ, JPCHEM_NK,&
...
REAL(KIND=JPRB), INTENT(IN) :: PJRAT(KLON,KLEV,JPCHEM_NJ)
REAL(KIND=JPRB), INTENT(OUT) :: PKRAT(KLON,KLEV,JPCHEM_NK)
END SUBROUTINE ACCH_KRAT
END INTERFACE
