INTERFACE
SUBROUTINE EC_PHYS_DRV_TL(YDGEOMETRY,YDGMV,YDSURF,YDMODEL,KGPCOMP,&
 & PB2,&
 & PGMV,PGMVS,PGFL,PGFL5,PGMVT1,PGMVT1S,PGFLT1,&
 & PSP_SB,PSP_SG,PSP_RR,PSD_VN,PSD_VD,YDTILEPROP,YDPHYSMWAVE,&
 & PFORCEU,PFORCEV,PFORCET,PFORCEQ,&
 & PII0,&
 & PTRAJEC,PTRAJEC_OOPS,YDPHYSMWAVE5,YDACV) 
...
USE YOMTRAJ_OOPS , ONLY : TRAJ_TYPE_OOPS, TRAJ_RAINGG_TLAD_TYPE
...
REAL(KIND=JPRB) ,INTENT(IN) :: PB2(YDGEOMETRY%YRDIM%NPROMA,YDMODEL%YRML_DYN%YRPTRSLB2%NFLDSLB2,YDGEOMETRY%YRDIM%NGPBLKS)
