INTERFACE
SUBROUTINE STEPOAD(YDGEOMETRY,YDFIELDS,YDMTRAJ,YDMODEL,CDCONF,PII0,YDVARBC,YDGOM5,YDGOM,YDACV)
...
REAL(KIND=JPRB) , INTENT(INOUT), OPTIONAL :: PII0
