...
DO JFLD = 1, SIZE (YDCPG_SL1%CRM)
  IF (COND (YDMODEL%YRML_GCONF%YGFL%YCRM(JFLD), YDMODEL)) ISIZE = ISIZE + 1
ENDDO
DO JFLD = 1, SIZE (YDCPG_SL1%LIMA)
