...
CONTAINS
  ...
  SUBROUTINE GREPVARS_PTR (VARIABLES, YDMODEL, COND, YDVARS_LIST)
    ...
    IF (COND (VARIABLES%Q, YDMODEL%YRML_GCONF%YGFL%YQ, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%I, YDMODEL%YRML_GCONF%YGFL%YI, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%L, YDMODEL%YRML_GCONF%YGFL%YL, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%LCONV, YDMODEL%YRML_GCONF%YGFL%YLCONV, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%ICONV, YDMODEL%YRML_GCONF%YGFL%YICONV, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%RCONV, YDMODEL%YRML_GCONF%YGFL%YRCONV, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%SCONV, YDMODEL%YRML_GCONF%YGFL%YSCONV, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%IRAD, YDMODEL%YRML_GCONF%YGFL%YIRAD, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%LRAD, YDMODEL%YRML_GCONF%YGFL%YLRAD, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%S, YDMODEL%YRML_GCONF%YGFL%YS, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%R, YDMODEL%YRML_GCONF%YGFL%YR, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%G, YDMODEL%YRML_GCONF%YGFL%YG, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%H, YDMODEL%YRML_GCONF%YGFL%YH, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%TKE, YDMODEL%YRML_GCONF%YGFL%YTKE, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%TTE, YDMODEL%YRML_GCONF%YGFL%YTTE, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%EFB1, YDMODEL%YRML_GCONF%YGFL%YEFB1, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%EFB2, YDMODEL%YRML_GCONF%YGFL%YEFB2, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%EFB3, YDMODEL%YRML_GCONF%YGFL%YEFB3, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%A, YDMODEL%YRML_GCONF%YGFL%YA, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%O3, YDMODEL%YRML_GCONF%YGFL%YO3, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%SRC, YDMODEL%YRML_GCONF%YGFL%YSRC, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%MXL, YDMODEL%YRML_GCONF%YGFL%YMXL, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%SHTUR, YDMODEL%YRML_GCONF%YGFL%YSHTUR, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%FQTUR, YDMODEL%YRML_GCONF%YGFL%YFQTUR, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%FSTUR, YDMODEL%YRML_GCONF%YGFL%YFSTUR, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%CPF, YDMODEL%YRML_GCONF%YGFL%YCPF, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%SPF, YDMODEL%YRML_GCONF%YGFL%YSPF, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%CVGQ, YDMODEL%YRML_GCONF%YGFL%YCVGQ, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%QVA, YDMODEL%YRML_GCONF%YGFL%YQVA, YDMODEL)) ISIZE = ISIZE + 1
    DO JFLD = 1, SIZE (VARIABLES%GHG)
      IF (COND (VARIABLES%GHG(JFLD), YDMODEL%YRML_GCONF%YGFL%YGHG(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%CHEM)
      IF (COND (VARIABLES%CHEM(JFLD), YDMODEL%YRML_GCONF%YGFL%YCHEM(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERO)
      IF (COND (VARIABLES%AERO(JFLD), YDMODEL%YRML_GCONF%YGFL%YAERO(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    IF (COND (VARIABLES%LRCH4, YDMODEL%YRML_GCONF%YGFL%YLRCH4, YDMODEL)) ISIZE = ISIZE + 1
    DO JFLD = 1, SIZE (VARIABLES%FORC)
      IF (COND (VARIABLES%FORC(JFLD), YDMODEL%YRML_GCONF%YGFL%YFORC(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%EZDIAG)
      IF (COND (VARIABLES%EZDIAG(JFLD), YDMODEL%YRML_GCONF%YGFL%YEZDIAG(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%ERA40)
      IF (COND (VARIABLES%ERA40(JFLD), YDMODEL%YRML_GCONF%YGFL%YERA40(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%NOGW)
      IF (COND (VARIABLES%NOGW(JFLD), YDMODEL%YRML_GCONF%YGFL%YNOGW(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%EDRP)
      IF (COND (VARIABLES%EDRP(JFLD), YDMODEL%YRML_GCONF%YGFL%YEDRP(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%SLDIA)
      IF (COND (VARIABLES%SLDIA(JFLD), YDMODEL%YRML_GCONF%YGFL%YSLDIA(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERAOT)
      IF (COND (VARIABLES%AERAOT(JFLD), YDMODEL%YRML_GCONF%YGFL%YAERAOT(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERLISI)
      IF (COND (VARIABLES%AERLISI(JFLD), YDMODEL%YRML_GCONF%YGFL%YAERLISI(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AEROUT)
      IF (COND (VARIABLES%AEROUT(JFLD), YDMODEL%YRML_GCONF%YGFL%YAEROUT(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AEROCLIM)
      IF (COND (VARIABLES%AEROCLIM(JFLD), YDMODEL%YRML_GCONF%YGFL%YAEROCLIM(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%UVP)
      IF (COND (VARIABLES%UVP(JFLD), YDMODEL%YRML_GCONF%YGFL%YUVP(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%PHYS)
      IF (COND (VARIABLES%PHYS(JFLD), YDMODEL%YRML_GCONF%YGFL%YPHYS(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    IF (COND (VARIABLES%PHYCTY, YDMODEL%YRML_GCONF%YGFL%YPHYCTY, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%RSPEC, YDMODEL%YRML_GCONF%YGFL%YRSPEC, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%SDSAT, YDMODEL%YRML_GCONF%YGFL%YSDSAT, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%CVV, YDMODEL%YRML_GCONF%YGFL%YCVV, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%RKTH, YDMODEL%YRML_GCONF%YGFL%YRKTH, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%RKTQV, YDMODEL%YRML_GCONF%YGFL%YRKTQV, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%RKTQC, YDMODEL%YRML_GCONF%YGFL%YRKTQC, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%UOM, YDMODEL%YRML_GCONF%YGFL%YUOM, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%UAL, YDMODEL%YRML_GCONF%YGFL%YUAL, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%DOM, YDMODEL%YRML_GCONF%YGFL%YDOM, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%DAL, YDMODEL%YRML_GCONF%YGFL%YDAL, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%UEN, YDMODEL%YRML_GCONF%YGFL%YUEN, YDMODEL)) ISIZE = ISIZE + 1
    IF (COND (VARIABLES%UNEBH, YDMODEL%YRML_GCONF%YGFL%YUNEBH, YDMODEL)) ISIZE = ISIZE + 1
    DO JFLD = 1, SIZE (VARIABLES%CRM)
      IF (COND (VARIABLES%CRM(JFLD), YDMODEL%YRML_GCONF%YGFL%YCRM(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%LIMA)
      IF (COND (VARIABLES%LIMA(JFLD), YDMODEL%YRML_GCONF%YGFL%YLIMA(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
    IF (COND (VARIABLES%FSD, YDMODEL%YRML_GCONF%YGFL%YFSD, YDMODEL)) ISIZE = ISIZE + 1
    DO JFLD = 1, SIZE (VARIABLES%EXT)
      IF (COND (VARIABLES%EXT(JFLD), YDMODEL%YRML_GCONF%YGFL%YEXT(JFLD), YDMODEL)) ISIZE = ISIZE + 1
    ENDDO
   ...
   IPNTR = 1
    ...
    IF (COND (VARIABLES%Q, YDMODEL%YRML_GCONF%YGFL%YQ, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%Q
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%Q%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%I, YDMODEL%YRML_GCONF%YGFL%YI, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%I
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%I%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%L, YDMODEL%YRML_GCONF%YGFL%YL, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%L
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%L%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%LCONV, YDMODEL%YRML_GCONF%YGFL%YLCONV, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%LCONV
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%LCONV%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%ICONV, YDMODEL%YRML_GCONF%YGFL%YICONV, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%ICONV
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%ICONV%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%RCONV, YDMODEL%YRML_GCONF%YGFL%YRCONV, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%RCONV
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%RCONV%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%SCONV, YDMODEL%YRML_GCONF%YGFL%YSCONV, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%SCONV
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%SCONV%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%IRAD, YDMODEL%YRML_GCONF%YGFL%YIRAD, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%IRAD
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%IRAD%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%LRAD, YDMODEL%YRML_GCONF%YGFL%YLRAD, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%LRAD
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%LRAD%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%S, YDMODEL%YRML_GCONF%YGFL%YS, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%S
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%S%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%R, YDMODEL%YRML_GCONF%YGFL%YR, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%R
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%R%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%G, YDMODEL%YRML_GCONF%YGFL%YG, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%G
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%G%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%H, YDMODEL%YRML_GCONF%YGFL%YH, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%H
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%H%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%TKE, YDMODEL%YRML_GCONF%YGFL%YTKE, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%TKE
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%TKE%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%TTE, YDMODEL%YRML_GCONF%YGFL%YTTE, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%TTE
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%TTE%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%EFB1, YDMODEL%YRML_GCONF%YGFL%YEFB1, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%EFB1
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%EFB1%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%EFB2, YDMODEL%YRML_GCONF%YGFL%YEFB2, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%EFB2
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%EFB2%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%EFB3, YDMODEL%YRML_GCONF%YGFL%YEFB3, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%EFB3
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%EFB3%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%A, YDMODEL%YRML_GCONF%YGFL%YA, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%A
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%A%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%O3, YDMODEL%YRML_GCONF%YGFL%YO3, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%O3
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%O3%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%SRC, YDMODEL%YRML_GCONF%YGFL%YSRC, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%SRC
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%SRC%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%MXL, YDMODEL%YRML_GCONF%YGFL%YMXL, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%MXL
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%MXL%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%SHTUR, YDMODEL%YRML_GCONF%YGFL%YSHTUR, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%SHTUR
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%SHTUR%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%FQTUR, YDMODEL%YRML_GCONF%YGFL%YFQTUR, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%FQTUR
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%FQTUR%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%FSTUR, YDMODEL%YRML_GCONF%YGFL%YFSTUR, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%FSTUR
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%FSTUR%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%CPF, YDMODEL%YRML_GCONF%YGFL%YCPF, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%CPF
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%CPF%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%SPF, YDMODEL%YRML_GCONF%YGFL%YSPF, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%SPF
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%SPF%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%CVGQ, YDMODEL%YRML_GCONF%YGFL%YCVGQ, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%CVGQ
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%CVGQ%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%QVA, YDMODEL%YRML_GCONF%YGFL%YQVA, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%QVA
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%QVA%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    DO JFLD = 1, SIZE (VARIABLES%GHG)
      IF (COND (VARIABLES%GHG(JFLD), YDMODEL%YRML_GCONF%YGFL%YGHG(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%GHG(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%GHG(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%CHEM)
      IF (COND (VARIABLES%CHEM(JFLD), YDMODEL%YRML_GCONF%YGFL%YCHEM(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%CHEM(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%CHEM(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERO)
      IF (COND (VARIABLES%AERO(JFLD), YDMODEL%YRML_GCONF%YGFL%YAERO(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%AERO(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%AERO(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    IF (COND (VARIABLES%LRCH4, YDMODEL%YRML_GCONF%YGFL%YLRCH4, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%LRCH4
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%LRCH4%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    DO JFLD = 1, SIZE (VARIABLES%FORC)
      IF (COND (VARIABLES%FORC(JFLD), YDMODEL%YRML_GCONF%YGFL%YFORC(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%FORC(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%FORC(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%EZDIAG)
      IF (COND (VARIABLES%EZDIAG(JFLD), YDMODEL%YRML_GCONF%YGFL%YEZDIAG(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%EZDIAG(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%EZDIAG(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%ERA40)
      IF (COND (VARIABLES%ERA40(JFLD), YDMODEL%YRML_GCONF%YGFL%YERA40(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%ERA40(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%ERA40(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%NOGW)
      IF (COND (VARIABLES%NOGW(JFLD), YDMODEL%YRML_GCONF%YGFL%YNOGW(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%NOGW(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%NOGW(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%EDRP)
      IF (COND (VARIABLES%EDRP(JFLD), YDMODEL%YRML_GCONF%YGFL%YEDRP(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%EDRP(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%EDRP(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%SLDIA)
      IF (COND (VARIABLES%SLDIA(JFLD), YDMODEL%YRML_GCONF%YGFL%YSLDIA(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%SLDIA(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%SLDIA(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERAOT)
      IF (COND (VARIABLES%AERAOT(JFLD), YDMODEL%YRML_GCONF%YGFL%YAERAOT(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%AERAOT(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%AERAOT(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERLISI)
      IF (COND (VARIABLES%AERLISI(JFLD), YDMODEL%YRML_GCONF%YGFL%YAERLISI(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%AERLISI(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%AERLISI(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AEROUT)
      IF (COND (VARIABLES%AEROUT(JFLD), YDMODEL%YRML_GCONF%YGFL%YAEROUT(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%AEROUT(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%AEROUT(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AEROCLIM)
      IF (COND (VARIABLES%AEROCLIM(JFLD), YDMODEL%YRML_GCONF%YGFL%YAEROCLIM(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%AEROCLIM(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%AEROCLIM(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%UVP)
      IF (COND (VARIABLES%UVP(JFLD), YDMODEL%YRML_GCONF%YGFL%YUVP(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%UVP(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%UVP(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%PHYS)
      IF (COND (VARIABLES%PHYS(JFLD), YDMODEL%YRML_GCONF%YGFL%YPHYS(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%PHYS(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%PHYS(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    IF (COND (VARIABLES%PHYCTY, YDMODEL%YRML_GCONF%YGFL%YPHYCTY, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%PHYCTY
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%PHYCTY%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%RSPEC, YDMODEL%YRML_GCONF%YGFL%YRSPEC, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%RSPEC
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%RSPEC%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%SDSAT, YDMODEL%YRML_GCONF%YGFL%YSDSAT, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%SDSAT
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%SDSAT%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%CVV, YDMODEL%YRML_GCONF%YGFL%YCVV, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%CVV
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%CVV%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%RKTH, YDMODEL%YRML_GCONF%YGFL%YRKTH, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%RKTH
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%RKTH%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%RKTQV, YDMODEL%YRML_GCONF%YGFL%YRKTQV, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%RKTQV
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%RKTQV%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%RKTQC, YDMODEL%YRML_GCONF%YGFL%YRKTQC, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%RKTQC
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%RKTQC%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%UOM, YDMODEL%YRML_GCONF%YGFL%YUOM, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%UOM
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%UOM%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%UAL, YDMODEL%YRML_GCONF%YGFL%YUAL, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%UAL
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%UAL%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%DOM, YDMODEL%YRML_GCONF%YGFL%YDOM, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%DOM
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%DOM%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%DAL, YDMODEL%YRML_GCONF%YGFL%YDAL, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%DAL
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%DAL%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%UEN, YDMODEL%YRML_GCONF%YGFL%YUEN, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%UEN
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%UEN%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    IF (COND (VARIABLES%UNEBH, YDMODEL%YRML_GCONF%YGFL%YUNEBH, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%UNEBH
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%UNEBH%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    DO JFLD = 1, SIZE (VARIABLES%CRM)
      IF (COND (VARIABLES%CRM(JFLD), YDMODEL%YRML_GCONF%YGFL%YCRM(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%CRM(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%CRM(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%LIMA)
      IF (COND (VARIABLES%LIMA(JFLD), YDMODEL%YRML_GCONF%YGFL%YLIMA(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%LIMA(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%LIMA(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
    IF (COND (VARIABLES%FSD, YDMODEL%YRML_GCONF%YGFL%YFSD, YDMODEL)) THEN
      YDVARS_LIST (IPNTR)%YV => VARIABLES%FSD
      YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%FSD%YCOMP
      IPNTR = IPNTR + 1
    ENDIF
    DO JFLD = 1, SIZE (VARIABLES%EXT)
      IF (COND (VARIABLES%EXT(JFLD), YDMODEL%YRML_GCONF%YGFL%YEXT(JFLD), YDMODEL)) THEN
        YDVARS_LIST (IPNTR)%YV => VARIABLES%EXT(JFLD)
        YDVARS_LIST (IPNTR)%YCOMP = VARIABLES%EXT(JFLD)%YCOMP
        IPNTR = IPNTR + 1
      ENDIF
    ENDDO
  ...
  SUBROUTINE FIELD_REGISTRY_REGISTER_SURFACE_FIELDS(SELF, SURFVARS, YDSURF, PERSISTENT)
    ...
    IF (YSD_PFD%NDIM == 0) THEN
      SURFVARS%GSD_PF%F_GROUP = CREATE_TEMPORARY(GEOM=SELF%GEOM, NLEV=MAX(1,YSD_PFD%NLEVS), NDIM=1, PERSISTENT=PERSISTENT)
    ELSE
      SURFVARS%GSD_PF%F_GROUP = FIELD_4D(DATA=SD_PF)
    END IF
    END ASSOCIATE
