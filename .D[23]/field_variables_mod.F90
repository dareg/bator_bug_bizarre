...
TYPE FIELD_VARIABLES
  ...
  TYPE(VARIABLE_3D) :: CURHS  ! 
  TYPE(VARIABLE_3D) :: CVRHS  ! 
  TYPE(VARIABLE_3D) :: CTRHS  ! 
  TYPE(VARIABLE_3D) :: CSPDRHS  ! 
  TYPE(VARIABLE_3D) :: CSVDRHS  ! 
  TYPE(VARIABLE_3D) :: NHXNL  ! 
  TYPE(VARIABLE_3D) :: CNHXNL  ! 
...
!   END DO
    ...
    SELF%GFL_PTR (IPNTR)%YV => SELF%Q
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%Q%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%I
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%I%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%L
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%L%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%LCONV
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%LCONV%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%ICONV
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%ICONV%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%RCONV
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%RCONV%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%SCONV
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%SCONV%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%IRAD
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%IRAD%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%LRAD
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%LRAD%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%S
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%S%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%R
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%R%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%G
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%G%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%H
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%H%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%TKE
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%TKE%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%TTE
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%TTE%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%EFB1
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%EFB1%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%EFB2
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%EFB2%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%EFB3
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%EFB3%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%A
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%A%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%O3
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%O3%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%SRC
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%SRC%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%MXL
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%MXL%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%SHTUR
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%SHTUR%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%FQTUR
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%FQTUR%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%FSTUR
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%FSTUR%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%CPF
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%CPF%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%SPF
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%SPF%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%CVGQ
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%CVGQ%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%QVA
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%QVA%YCOMP
    IPNTR = IPNTR + 1
    DO JFLD = 1, SIZE (SELF%GHG)
      SELF%GFL_PTR (IPNTR)%YV => SELF%GHG(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%GHG(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%CHEM)
      SELF%GFL_PTR (IPNTR)%YV => SELF%CHEM(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%CHEM(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%AERO)
      SELF%GFL_PTR (IPNTR)%YV => SELF%AERO(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%AERO(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    SELF%GFL_PTR (IPNTR)%YV => SELF%LRCH4
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%LRCH4%YCOMP
    IPNTR = IPNTR + 1
    DO JFLD = 1, SIZE (SELF%FORC)
      SELF%GFL_PTR (IPNTR)%YV => SELF%FORC(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%FORC(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%EZDIAG)
      SELF%GFL_PTR (IPNTR)%YV => SELF%EZDIAG(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%EZDIAG(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%ERA40)
      SELF%GFL_PTR (IPNTR)%YV => SELF%ERA40(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%ERA40(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%NOGW)
      SELF%GFL_PTR (IPNTR)%YV => SELF%NOGW(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%NOGW(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%EDRP)
      SELF%GFL_PTR (IPNTR)%YV => SELF%EDRP(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%EDRP(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%SLDIA)
      SELF%GFL_PTR (IPNTR)%YV => SELF%SLDIA(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%SLDIA(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%AERAOT)
      SELF%GFL_PTR (IPNTR)%YV => SELF%AERAOT(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%AERAOT(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%AERLISI)
      SELF%GFL_PTR (IPNTR)%YV => SELF%AERLISI(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%AERLISI(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%AEROUT)
      SELF%GFL_PTR (IPNTR)%YV => SELF%AEROUT(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%AEROUT(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%AEROCLIM)
      SELF%GFL_PTR (IPNTR)%YV => SELF%AEROCLIM(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%AEROCLIM(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%UVP)
      SELF%GFL_PTR (IPNTR)%YV => SELF%UVP(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%UVP(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%PHYS)
      SELF%GFL_PTR (IPNTR)%YV => SELF%PHYS(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%PHYS(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    SELF%GFL_PTR (IPNTR)%YV => SELF%PHYCTY
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%PHYCTY%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%RSPEC
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%RSPEC%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%SDSAT
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%SDSAT%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%CVV
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%CVV%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%RKTH
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%RKTH%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%RKTQV
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%RKTQV%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%RKTQC
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%RKTQC%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%UOM
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%UOM%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%UAL
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%UAL%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%DOM
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%DOM%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%DAL
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%DAL%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%UEN
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%UEN%YCOMP
    IPNTR = IPNTR + 1
    SELF%GFL_PTR (IPNTR)%YV => SELF%UNEBH
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%UNEBH%YCOMP
    IPNTR = IPNTR + 1
    DO JFLD = 1, SIZE (SELF%CRM)
      SELF%GFL_PTR (IPNTR)%YV => SELF%CRM(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%CRM(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (SELF%LIMA)
      SELF%GFL_PTR (IPNTR)%YV => SELF%LIMA(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%LIMA(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
    SELF%GFL_PTR (IPNTR)%YV => SELF%FSD
    SELF%GFL_PTR (IPNTR)%YCOMP = SELF%FSD%YCOMP
    IPNTR = IPNTR + 1
    DO JFLD = 1, SIZE (SELF%EXT)
      SELF%GFL_PTR (IPNTR)%YV => SELF%EXT(JFLD)
      SELF%GFL_PTR (IPNTR)%YCOMP = SELF%EXT(JFLD)%YCOMP
      IPNTR = IPNTR + 1
    ENDDO
