...
TYPE CPG_TNDHD_DDH_TYPE
  ...
  TYPE (FIELD_3D), POINTER :: F_PD => NULL ()
  REAL (KIND=JPRB), POINTER :: PD (:,:) => NULL ()
  TYPE (FIELD_3D), POINTER :: F_VD => NULL ()
...
TYPE CPG_TNDSL_DDH_TYPE
  ...
  TYPE (CPG_TNDSL_DDH_3D_TYPE), ALLOCATABLE :: PHYS (:)
  ...
  TYPE (CPG_TNDSL_DDH_3D_TYPE), ALLOCATABLE :: CRM (:)
...
IF (ALLOCATED (YDGPDDH%GMVTNDSI_DDH)) THEN
  ...
  SELF%U = VARIABLE_3D ("U", LACTIVE=.TRUE., LT1=LLT1, LT9=LLT9)
  IF (LLT0) THEN
    SELF%U%FT0 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_U0,:))
  ELSE
    SELF%U%FT0 => NULL ()
  ENDIF
  IF (LLT1) THEN
    SELF%U%FT1 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_U1,:))
  ELSE
    SELF%U%FT1 => NULL ()
  ENDIF
  IF (LLT9) THEN
    SELF%U%FT9 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_U9,:))
  ELSE
    SELF%U%FT9 => NULL ()
  ENDIF
  ...
  SELF%V = VARIABLE_3D ("V", LACTIVE=.TRUE., LT1=LLT1, LT9=LLT9)
  IF (LLT0) THEN
    SELF%V%FT0 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_V0,:))
  ELSE
    SELF%V%FT0 => NULL ()
  ENDIF
  IF (LLT1) THEN
    SELF%V%FT1 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_V1,:))
  ELSE
    SELF%V%FT1 => NULL ()
  ENDIF
  IF (LLT9) THEN
    SELF%V%FT9 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_V9,:))
  ELSE
    SELF%V%FT9 => NULL ()
  ENDIF
  ...
  SELF%T = VARIABLE_3D ("T", LACTIVE=.TRUE., LT1=LLT1, LT9=LLT9)
  IF (LLT0) THEN
    SELF%T%FT0 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_T0,:))
  ELSE
    SELF%T%FT0 => NULL ()
  ENDIF
  IF (LLT1) THEN
    SELF%T%FT1 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_T1,:))
  ELSE
    SELF%T%FT1 => NULL ()
  ENDIF
  IF (LLT9) THEN
    SELF%T%FT9 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_T9,:))
  ELSE
    SELF%T%FT9 => NULL ()
  ENDIF
  ...
  SELF%PD = VARIABLE_3D ("PD", LACTIVE=.TRUE., LT1=LLT1, LT9=LLT9)
  IF (LLT0) THEN
    SELF%PD%FT0 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_PD0,:))
  ELSE
    SELF%PD%FT0 => NULL ()
  ENDIF
  IF (LLT1) THEN
    SELF%PD%FT1 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_PD1,:))
  ELSE
    SELF%PD%FT1 => NULL ()
  ENDIF
  IF (LLT9) THEN
    SELF%PD%FT9 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_PD9,:))
  ELSE
    SELF%PD%FT9 => NULL ()
  ENDIF
  ...
  SELF%VD = VARIABLE_3D ("VD", LACTIVE=.TRUE., LT1=LLT1, LT9=LLT9)
  IF (LLT0) THEN
    SELF%VD%FT0 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_VD0,:))
  ELSE
    SELF%VD%FT0 => NULL ()
  ENDIF
  IF (LLT1) THEN
    SELF%VD%FT1 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_VD1,:))
  ELSE
    SELF%VD%FT1 => NULL ()
  ENDIF
  IF (LLT9) THEN
    SELF%VD%FT9 => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSI_DDH (:,:,YDMDDH%MSIDDH_VD9,:))
  ELSE
    SELF%VD%FT9 => NULL ()
  ENDIF
...
IF (ALLOCATED (YDGPDDH%GMVTNDHD_DDH)) THEN
  ...
  IF (YDMDDH%MHDDDH_U > 0) THEN
    SELF%F_U => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDHD_DDH (:,:,YDMDDH%MHDDDH_U,:), PERSISTENT=.TRUE.)
  ENDIF
  IF (YDMDDH%MHDDDH_V > 0) THEN
    SELF%F_V => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDHD_DDH (:,:,YDMDDH%MHDDDH_V,:), PERSISTENT=.TRUE.)
  ENDIF
  IF (YDMDDH%MHDDDH_T > 0) THEN
    SELF%F_T => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDHD_DDH (:,:,YDMDDH%MHDDDH_T,:), PERSISTENT=.TRUE.)
  ENDIF
  IF (YDMDDH%MHDDDH_PD > 0) THEN
    SELF%F_PD => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDHD_DDH (:,:,YDMDDH%MHDDDH_PD,:), PERSISTENT=.TRUE.)
  ENDIF
  IF (YDMDDH%MHDDDH_VD > 0) THEN
    SELF%F_VD => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDHD_DDH (:,:,YDMDDH%MHDDDH_VD,:), PERSISTENT=.TRUE.)
  ENDIF
  IF (YDMDDH%MHDDDH_NHX > 0) THEN
    SELF%F_NHX => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDHD_DDH (:,:,YDMDDH%MHDDDH_NHX,:), PERSISTENT=.TRUE.)
  ENDIF
...
IF (ALLOCATED (YDGPDDH%GFLTNDHD_DDH)) THEN
  ...
  IF (YDMDDH%MHDDDH_Q) THEN
    SELF%F_Q => CREATE_FIELD_WRAP (YDGPDDH%GFLTNDHD_DDH (:,:,YDMDDH%MHDDDH_Q,:), PERSISTENT=.TRUE.)
  ENDIF
...
IF (ASSOCIATED (SELF%F_U)) THEN
  CALL DELETE_TEMPORARY (SELF%F_U)
  SELF%F_U => NULL ()
  SELF%U => NULL ()
ENDIF
IF (ASSOCIATED (SELF%F_V)) THEN
  CALL DELETE_TEMPORARY (SELF%F_V)
  SELF%F_V => NULL ()
  SELF%V => NULL ()
ENDIF
IF (ASSOCIATED (SELF%F_T)) THEN
  CALL DELETE_TEMPORARY (SELF%F_T)
  SELF%F_T => NULL ()
  SELF%T => NULL ()
ENDIF
IF (ASSOCIATED (SELF%F_PD)) THEN
  CALL DELETE_TEMPORARY (SELF%F_PD)
  SELF%F_PD => NULL ()
  SELF%PD => NULL ()
ENDIF
IF (ASSOCIATED (SELF%F_VD)) THEN
  CALL DELETE_TEMPORARY (SELF%F_VD)
  SELF%F_VD => NULL ()
  SELF%VD => NULL ()
ENDIF
IF (ASSOCIATED (SELF%F_NHX)) THEN
  CALL DELETE_TEMPORARY (SELF%F_NHX)
  SELF%F_NHX => NULL ()
  SELF%NHX => NULL ()
ENDIF
IF (ASSOCIATED (SELF%F_Q)) THEN
  CALL DELETE_TEMPORARY (SELF%F_Q)
  SELF%F_Q => NULL ()
  SELF%Q => NULL ()
ENDIF
...
IF (ALLOCATED (YDGPDDH%GMVTNDSL_DDH)) THEN
  ...
  IF (YDMDDH%MSLDDH_U > 0) THEN
    SELF%U%F_P => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSL_DDH (:,:,YDMDDH%MSLDDH_U,:))
  ENDIF
  IF (YDMDDH%MSLDDH_V > 0) THEN
    SELF%V%F_P => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSL_DDH (:,:,YDMDDH%MSLDDH_V,:))
  ENDIF
  IF (YDMDDH%MSLDDH_T > 0) THEN
    SELF%T%F_P => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSL_DDH (:,:,YDMDDH%MSLDDH_T,:))
  ENDIF
  IF (YDMDDH%MSLDDH_PD > 0) THEN
    SELF%PD%F_P => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSL_DDH (:,:,YDMDDH%MSLDDH_PD,:))
  ENDIF
  IF (YDMDDH%MSLDDH_VD > 0) THEN
    SELF%VD%F_P => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSL_DDH (:,:,YDMDDH%MSLDDH_VD,:))
  ENDIF
  IF (YDMDDH%MSLDDH_NHX > 0) THEN
    SELF%NHX%F_P => CREATE_FIELD_WRAP (YDGPDDH%GMVTNDSL_DDH (:,:,YDMDDH%MSLDDH_NHX,:))
  ENDIF
ENDIF
...
IF (ALLOCATED (YDGPDDH%GFLTNDSL_DDH)) THEN
  ...
  IF (ASSOCIATED (YGFL%YUVP)) THEN
    ...
    ENDDO
  ENDIF
  IF (ASSOCIATED (YGFL%YPHYS)) THEN
    IFLD = SIZE (YGFL%YPHYS)
    ALLOCATE (SELF%PHYS (IFLD))
    DO JFLD = 1, IFLD
      WRITE (CLI, '(I0)') JFLD
      CLNAME = "PHYS_"//TRIM (CLI)
      CALL CPG_TNDSL_DDH_TYPE_INIT_V (SELF%PHYS (JFLD)%F_P, CLNAME, YGFL%YPHYS (JFLD))
    ENDDO
  ENDIF
  ...
  IF (ASSOCIATED (YGFL%YCRM)) THEN
    IFLD = SIZE (YGFL%YCRM)
    ALLOCATE (SELF%CRM (IFLD))
    DO JFLD = 1, IFLD
      WRITE (CLI, '(I0)') JFLD
      CLNAME = "CRM_"//TRIM (CLI)
      CALL CPG_TNDSL_DDH_TYPE_INIT_V (SELF%CRM (JFLD)%F_P, CLNAME, YGFL%YCRM (JFLD))
    ENDDO
  ENDIF
...
IF (YDCOMP%MP > 0) THEN
  ...
  ENDIF
  YDF => CREATE_FIELD_WRAP (YDGPDDH%GFLTNDSL_DDH (:,:,YDCOMP%MP,:))
ENDIF
...
IF (ALLOCATED (SELF%UVP)) THEN
  ...
  ENDDO
ENDIF
IF (ALLOCATED (SELF%PHYS)) THEN
  IFLD = SIZE (SELF%PHYS)
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%PHYS (JFLD)%F_P)) THEN
      SELF%PHYS (JFLD)%P => SELF%PHYS (JFLD)%F_P%GET_VIEW (BLOCK_INDEX)
    ENDIF
  ENDDO
ENDIF
...
ENDIF
IF (ALLOCATED (SELF%CRM)) THEN
  IFLD = SIZE (SELF%CRM)
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%CRM (JFLD)%F_P)) THEN
      SELF%CRM (JFLD)%P => SELF%CRM (JFLD)%F_P%GET_VIEW (BLOCK_INDEX)
    ENDIF
  ENDDO
ENDIF
...
IF (ASSOCIATED (SELF%U%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%U%F_P)
  SELF%U%F_P => NULL ()  
  SELF%U%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%V%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%V%F_P)
  SELF%V%F_P => NULL ()  
  SELF%V%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%T%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%T%F_P)
  SELF%T%F_P => NULL ()  
  SELF%T%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%PD%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%PD%F_P)
  SELF%PD%F_P => NULL ()  
  SELF%PD%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%VD%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%VD%F_P)
  SELF%VD%F_P => NULL ()  
  SELF%VD%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%NHX%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%NHX%F_P)
  SELF%NHX%F_P => NULL ()  
  SELF%NHX%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%Q%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%Q%F_P)
  SELF%Q%F_P => NULL ()
  SELF%Q%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%I%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%I%F_P)
  SELF%I%F_P => NULL ()
  SELF%I%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%L%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%L%F_P)
  SELF%L%F_P => NULL ()
  SELF%L%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%LCONV%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%LCONV%F_P)
  SELF%LCONV%F_P => NULL ()
  SELF%LCONV%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%ICONV%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%ICONV%F_P)
  SELF%ICONV%F_P => NULL ()
  SELF%ICONV%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%RCONV%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%RCONV%F_P)
  SELF%RCONV%F_P => NULL ()
  SELF%RCONV%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%SCONV%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%SCONV%F_P)
  SELF%SCONV%F_P => NULL ()
  SELF%SCONV%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%IRAD%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%IRAD%F_P)
  SELF%IRAD%F_P => NULL ()
  SELF%IRAD%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%LRAD%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%LRAD%F_P)
  SELF%LRAD%F_P => NULL ()
  SELF%LRAD%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%S%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%S%F_P)
  SELF%S%F_P => NULL ()
  SELF%S%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%R%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%R%F_P)
  SELF%R%F_P => NULL ()
  SELF%R%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%G%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%G%F_P)
  SELF%G%F_P => NULL ()
  SELF%G%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%H%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%H%F_P)
  SELF%H%F_P => NULL ()
  SELF%H%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%TKE%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%TKE%F_P)
  SELF%TKE%F_P => NULL ()
  SELF%TKE%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%TTE%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%TTE%F_P)
  SELF%TTE%F_P => NULL ()
  SELF%TTE%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%EFB1%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%EFB1%F_P)
  SELF%EFB1%F_P => NULL ()
  SELF%EFB1%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%EFB2%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%EFB2%F_P)
  SELF%EFB2%F_P => NULL ()
  SELF%EFB2%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%EFB3%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%EFB3%F_P)
  SELF%EFB3%F_P => NULL ()
  SELF%EFB3%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%A%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%A%F_P)
  SELF%A%F_P => NULL ()
  SELF%A%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%O3%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%O3%F_P)
  SELF%O3%F_P => NULL ()
  SELF%O3%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%SRC%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%SRC%F_P)
  SELF%SRC%F_P => NULL ()
  SELF%SRC%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%MXL%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%MXL%F_P)
  SELF%MXL%F_P => NULL ()
  SELF%MXL%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%SHTUR%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%SHTUR%F_P)
  SELF%SHTUR%F_P => NULL ()
  SELF%SHTUR%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%FQTUR%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%FQTUR%F_P)
  SELF%FQTUR%F_P => NULL ()
  SELF%FQTUR%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%FSTUR%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%FSTUR%F_P)
  SELF%FSTUR%F_P => NULL ()
  SELF%FSTUR%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%CPF%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%CPF%F_P)
  SELF%CPF%F_P => NULL ()
  SELF%CPF%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%SPF%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%SPF%F_P)
  SELF%SPF%F_P => NULL ()
  SELF%SPF%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%CVGQ%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%CVGQ%F_P)
  SELF%CVGQ%F_P => NULL ()
  SELF%CVGQ%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%QVA%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%QVA%F_P)
  SELF%QVA%F_P => NULL ()
  SELF%QVA%P => NULL ()
ENDIF
IF (ALLOCATED (SELF%GHG)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%GHG (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%GHG (JFLD)%F_P)
...
IF (ALLOCATED (SELF%CHEM)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%CHEM (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%CHEM (JFLD)%F_P)
...
IF (ALLOCATED (SELF%AERO)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%AERO (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%AERO (JFLD)%F_P)
...
ENDIF
IF (ASSOCIATED (SELF%LRCH4%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%LRCH4%F_P)
  SELF%LRCH4%F_P => NULL ()
  SELF%LRCH4%P => NULL ()
ENDIF
IF (ALLOCATED (SELF%FORC)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%FORC (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%FORC (JFLD)%F_P)
...
IF (ALLOCATED (SELF%EZDIAG)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%EZDIAG (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%EZDIAG (JFLD)%F_P)
...
IF (ALLOCATED (SELF%ERA40)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%ERA40 (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%ERA40 (JFLD)%F_P)
...
IF (ALLOCATED (SELF%NOGW)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%NOGW (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%NOGW (JFLD)%F_P)
...
IF (ALLOCATED (SELF%EDRP)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%EDRP (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%EDRP (JFLD)%F_P)
...
IF (ALLOCATED (SELF%SLDIA)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%SLDIA (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%SLDIA (JFLD)%F_P)
...
IF (ALLOCATED (SELF%AERAOT)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%AERAOT (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%AERAOT (JFLD)%F_P)
...
IF (ALLOCATED (SELF%AERLISI)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%AERLISI (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%AERLISI (JFLD)%F_P)
...
IF (ALLOCATED (SELF%AEROUT)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%AEROUT (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%AEROUT (JFLD)%F_P)
...
IF (ALLOCATED (SELF%AEROCLIM)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%AEROCLIM (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%AEROCLIM (JFLD)%F_P)
...
IF (ALLOCATED (SELF%UVP)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%UVP (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%UVP (JFLD)%F_P)
...
IF (ALLOCATED (SELF%PHYS)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%PHYS (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%PHYS (JFLD)%F_P)
      SELF%PHYS (JFLD)%F_P => NULL ()
      SELF%PHYS (JFLD)%P => NULL ()
    ENDIF
  ENDDO
ENDIF
IF (ASSOCIATED (SELF%PHYCTY%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%PHYCTY%F_P)
  SELF%PHYCTY%F_P => NULL ()
  SELF%PHYCTY%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%RSPEC%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%RSPEC%F_P)
  SELF%RSPEC%F_P => NULL ()
  SELF%RSPEC%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%SDSAT%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%SDSAT%F_P)
  SELF%SDSAT%F_P => NULL ()
  SELF%SDSAT%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%CVV%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%CVV%F_P)
  SELF%CVV%F_P => NULL ()
  SELF%CVV%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%RKTH%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%RKTH%F_P)
  SELF%RKTH%F_P => NULL ()
  SELF%RKTH%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%RKTQV%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%RKTQV%F_P)
  SELF%RKTQV%F_P => NULL ()
  SELF%RKTQV%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%RKTQC%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%RKTQC%F_P)
  SELF%RKTQC%F_P => NULL ()
  SELF%RKTQC%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%UOM%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%UOM%F_P)
  SELF%UOM%F_P => NULL ()
  SELF%UOM%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%UAL%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%UAL%F_P)
  SELF%UAL%F_P => NULL ()
  SELF%UAL%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%DOM%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%DOM%F_P)
  SELF%DOM%F_P => NULL ()
  SELF%DOM%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%DAL%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%DAL%F_P)
  SELF%DAL%F_P => NULL ()
  SELF%DAL%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%UEN%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%UEN%F_P)
  SELF%UEN%F_P => NULL ()
  SELF%UEN%P => NULL ()
ENDIF
IF (ASSOCIATED (SELF%UNEBH%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%UNEBH%F_P)
  SELF%UNEBH%F_P => NULL ()
  SELF%UNEBH%P => NULL ()
ENDIF
IF (ALLOCATED (SELF%CRM)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%CRM (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%CRM (JFLD)%F_P)
      SELF%CRM (JFLD)%F_P => NULL ()
      SELF%CRM (JFLD)%P => NULL ()
    ENDIF
  ENDDO
ENDIF
IF (ALLOCATED (SELF%LIMA)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%LIMA (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%LIMA (JFLD)%F_P)
...
ENDIF
IF (ASSOCIATED (SELF%FSD%F_P)) THEN
  CALL DELETE_TEMPORARY (SELF%FSD%F_P)
  SELF%FSD%F_P => NULL ()
  SELF%FSD%P => NULL ()
ENDIF
IF (ALLOCATED (SELF%EXT)) THEN
  ...
  DO JFLD = 1, IFLD
    IF (ASSOCIATED (SELF%EXT (JFLD)%F_P)) THEN
      CALL DELETE_TEMPORARY (SELF%EXT (JFLD)%F_P)
